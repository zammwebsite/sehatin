...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a5.25 5.25 0 0 1-3.498 0l-3.722-.537A2.25 2.25 0 0 1 3 14.894V10.608c0-.97.616-1.813 1.5-2.097m16.5 0-2.25-2.25m0 0-2.25 2.25m2.25-2.25v10.5m-16.5 0 2.25 2.25m0 0 2.25-2.25m-2.25 2.25V3.375" />
  </svg>
);
