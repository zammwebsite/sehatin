...
{
id: 'initial',
text: 'Halo! Saya Sehatin, asisten medis AI Anda. Apa yang bisa saya bantu hari ini? Anda bisa bertanya tentang gejala, pola makan, atau kesehatan secara umum. Ingat, saya bukan dokter, jadi untuk kondisi serius, harap hubungi profesional medis.',
sender: 'ai',
},
]);
...
return ( <div className="flex flex-col h-full bg-white rounded-xl shadow-md overflow-hidden"> <div className="flex-1 p-4 sm:p-6 overflow-y-auto">
    ...
    {isLoading && (
      <div className="flex items-start gap-3 my-4">
        ...
        <div className="max-w-xl p-4 rounded-xl shadow-md bg-white text-slate-700 rounded-bl-none">
          <p className="text-sm italic text-gray-500">AI sedang mengetik...</p>
        </div>
      </div>
    )}
